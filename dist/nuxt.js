        ...
        case 8:
          ...
          templateVars = {
            ...
            router: {
              ...
              fallback: this.options.router.fallback,
...
/* harmony default export */ __webpack_exports__["a"] = (function () {
  ...
  */
  ...
  var distNuxtPath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_path__["join"])(distPath, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__utils__["isUrl"])(this.options.build.publicPath) ? '' : this.options.build.publicPath);
          ...
          switch (_context4.prev = _context4.next) {
            case 0:
              _loop = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _loop() {
                var n;
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _loop$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        n = 0;
                            ...
                            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                              while (1) {
                                switch (_context2.prev = _context2.next) {
                                  case 0:
                                    _context2.next = 2;
                                    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__utils__["waitFor"])(n++ * self.options.generate.interval);
